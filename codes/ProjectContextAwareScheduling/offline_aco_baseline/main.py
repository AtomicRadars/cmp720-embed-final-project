...
from .preemptive_aco_solver import (
    PreemptiveACOParams,
    PreemptiveACOSolver,
    print_preemptive_aco_history,
    print_preemptive_aco_result,
)
...
def main() -> None:
    ...
    print("\nRunning preemptive offline ACO solver")
    print("=====================================")
    ...
    preemptive_aco_params = PreemptiveACOParams(
        ...
        switch_weight=0.10,
        segment_contention_penalty_ms=2,
        enable_segment_contention_time=True,
        seed=42,
    )

    preemptive_aco_solver = PreemptiveACOSolver(
        jobs=jobs,
        params=preemptive_aco_params,
    )

    preemptive_aco_result = preemptive_aco_solver.run()

    print_preemptive_aco_result(preemptive_aco_result, first_segments=40)
    print_preemptive_aco_history(preemptive_aco_result, every=10)
